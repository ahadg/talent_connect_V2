...
import { authMock, authMockRequest, authMockResponse, authUserPayload } from '../../controllers/test/mocks/auth.mock';
import { read, resendEmail } from '../../controllers/current-user';
import * as auth from '../../services/auth.service';
//import * as helper from '@ahadg/jobber-shared';
import { Sequelize } from 'sequelize';

jest.mock('@ahadg/jobber-shared');
