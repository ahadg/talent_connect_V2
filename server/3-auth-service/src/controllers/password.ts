...
import { getAuthUserByPasswordToken, getUserByEmail, getUserByUsername, updatePassword, updatePasswordToken } from '../services/auth.service';
import { IAuthDocument, IEmailMessageDetails } from '@ahadg/jobber-shared';
...
//import { BadRequestError } from '@gateway/error-handler';
