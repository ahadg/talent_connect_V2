...
import { IAuthBuyerMessageDetails, IAuthDocument, firstLetterUppercase, lowerCase, winstonLogger } from '@ahadg/jobber-shared';
...
export async function createAuthUser(data: IAuthDocument): Promise<IAuthDocument | undefined> {
  try {
    console.log("MODEL_CREATING_DATA",data)
