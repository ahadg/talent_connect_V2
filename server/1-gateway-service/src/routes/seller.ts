import { Create } from '../controllers/users/seller/create';
import { Get } from '../controllers/users/seller/get';
import { SellerSeed } from '../controllers/users/seller/seed';
import { Update } from '../controllers/users/seller/update';
